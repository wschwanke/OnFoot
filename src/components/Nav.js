...
=======
      ...
      if (this.props.showSaveRestaurants===true){
        return <button onClick={this.props.toggleSavedRestaurants}>Go back</button>
      }else {
        return <button onClick={this.props.toggleSavedRestaurants}>Show saved restaurants</button>
>>>>>>> Now saving all info into database
      }
    } 
  }
